...
#+BEGIN_SRC clojure :noweb-ref const
  ...
  (def ^:const POS_INF #+clj Double/POSITIVE_INFINITY #+cljs (.-POSITIVE_INFINITY js/Number))
  (def ^:const NEG_INF #+clj Double/NEGATIVE_INFINITY #+cljs (.-NEGATIVE_INFINITY js/Number))
